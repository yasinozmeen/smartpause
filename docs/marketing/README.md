...
Video: `src/demo.html?t=<saniye>` her kare için Chrome headless ile render edilip ffmpeg ile birleştirildi (12 fps, 9 sn; GIF 1.3× hızlı, 15 fps, 1600 px). Pencere yakalamaları `screencapture -o -l <windowID>` ile (gölgesiz).
